...
<body>
            ...
            <div class="column-row px-4">
                <div class="col-lg-10 mx-auto">
                    ...
                    <input type="text" class="form-control" required name="name" id="Name"
                        autocomplete="off" placeholder="{{ __('Your name') }}">
                </div>
                <div class="col-lg-10 mx-auto">
                ...
                <div class="col-lg-10 mx-auto">
                    ...
                    <input type="text" class="form-control" required name="subject" id="Subject"
                        autocomplete="off" placeholder="{{ __('The subject of your email') }}">
                </div>
                <div class="col-lg-10 mx-auto">
    ...
    <footer class="bg-dark mt-auto text-center text-white ">
        <div class="container p-4 pb-0">
            ...
            <!-- GitHub -->
            <a id="logoGitHub" class="btn btn-outline-light btn-floating m-1" href="https://github.com/jcomte23/ContactForm"
                role="button">
